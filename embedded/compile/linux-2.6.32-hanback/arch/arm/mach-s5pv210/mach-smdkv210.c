...
#include <media/mt9t111_platform.h>
...
#endif
#ifdef CONFIG_SERIAL_8250_EXAR_ST16C550_HANBACK
static struct platform_device st16c554_uart_device4 = {
  .name           = "st16c554-uart",
  .id             = 4,
};
#endif
...
static int smdkv210_cam0_power(int onoff)
{
  ...
  /* S5K4EA Reset */
  err = gpio_request(S5PV210_GPC0(1), "GPC0");
  if (err)
    printk(KERN_ERR "#### failed to request GPC0 for S5K4EA Camera Reset\n");

  s3c_gpio_setpull(S5PV210_GPC0(1), S3C_GPIO_PULL_NONE);
  gpio_direction_output(S5PV210_GPC0(1), 0);
  udelay(1000);
  gpio_direction_output(S5PV210_GPC0(1), 1);
  gpio_free(S5PV210_GPC0(1));
#endif
...
#if !defined(CONFIG_MACH_EMPOS3) && !defined(CONFIG_MACH_ADKSV210) && !defined(CONFIG_MACH_EDKSV210) && !defined(CONFIG_MACH_SM3SV210)
...
/* undef : 3BA */
#elif CONFIG_VIDEO_MT9T111
#define MT9T111_ENABLED
/* undef : MT9T111 */
#endif
#endif
#endif
...
#ifdef MT9T111_ENABLED
static struct mt9t111_platform_data mt9t111_plat = {
  .default_width = 640,
  .default_height = 480,
  .pixelformat = V4L2_PIX_FMT_UYVY,
  .freq = 48000000,
...
static struct i2c_board_info  mt9t111_i2c_info = {
  I2C_BOARD_INFO("MT9T111", 0x3c),
  .platform_data = &mt9t111_plat,
};

static struct s3c_platform_camera mt9t111 = {
  .id   = CAMERA_PAR_A,
  .type   = CAM_TYPE_ITU,
  .fmt    = ITU_601_YCBCR422_8BIT,
  .order422 = CAM_ORDER422_8BIT_CBYCRY,
  .i2c_busnum = 0,
  .info   = &mt9t111_i2c_info,
  .pixelformat  = V4L2_PIX_FMT_UYVY,
  .srclk_name = "mout_mpll",
  .clk_name = "sclk_cam1",
  .clk_rate = 48000000,
...
static unsigned int s3c_smc911x_gpio_init(void)
{
  u32 err;

  err = gpio_request(S5PV210_GPH1(1), "GPH1");
  if (err) {
    printk(KERN_INFO "gpio request error : %d\n", err);
  } else {
    s3c_gpio_cfgpin(S5PV210_GPH1(1), (0xf << 4));
...
static void __init smdkv210_smc911x_set(void)
{
  unsigned int tmp;

  s3c_smc911x_gpio_init();

#if 0
  tmp = ((4<<24)|(0<<20)|(0xe<<16)|(1<<12)|(4<<8)|(6<<4)|(0<<0));
...
static struct resource s3c_smc911x_resources[] = {
  [0] = {
    .start  = S5PV210_PA_SMC9115,
    .end    = S5PV210_PA_SMC9115 + 0x100,
...
static struct smc911x_platdata s3c_smc911x_platdata = {
...
struct platform_device s3c_device_smc911x = {
  ...
  .dev        = {
    .platform_data = &s3c_smc911x_platdata,
  }
};
#endif
...
static struct resource empos3_sc100_oxu210hp_resources[] = {
  {
    .start  = S5PV210_PA_OXU210USBHOST,
    .end    = S5PV210_PA_OXU210USBHOST + (64 << 20) - 1,
    .flags  = IORESOURCE_MEM,
  },
  {
    .start  = IRQ_EINT(16),
...
static struct oxu210hp_platform_data empos3_sc100_oxu210hp_platform_data = {
  .bus16          = 1,
  .use_hcd_otg    = 1,
  .use_hcd_sph    = 1,
};

static u64 oxu210_device_usb_dmamask = 0xffffffffUL;
static struct platform_device empos3_sc100_oxu210hp = {
  .name           = "oxu210hp-hcd",
  .id             = -1,
  .num_resources  = 2,
  .resource       = empos3_sc100_oxu210hp_resources,
  .dev            = {
    .dma_mask               = 0UL,
    .coherent_dma_mask      = 0xffffffff,
    .platform_data          =
      &empos3_sc100_oxu210hp_platform_data,
  },
};

static void __init smdkv210_oxu210hp_set(void)
{
  u32 err;
...
#if defined(CONFIG_MACH_SM3SV210)
/* reset off ZigbeX */
static void zigbex_init(void)
{
  s3c_gpio_cfgpin(S5PV210_GPG2(0), S3C_GPIO_OUTPUT);
  s3c_gpio_setpull(S5PV210_GPG2(0), S3C_GPIO_PULL_UP);
  s3c_gpio_setpin(S5PV210_GPG2(0), 0);
  msleep(100);
  s3c_gpio_setpin(S5PV210_GPG2(0), 1);
}
#endif
...
#endif
#ifdef CONFIG_SERIAL_8250_EXAR_ST16C550_HANBACK
  &st16c554_uart_device4,
#endif
#ifdef CONFIG_USB_OXU210HP_HCD
  &empos3_sc100_oxu210hp,
#endif
};
...
#ifdef CONFIG_SMC911X
  smdkv210_smc911x_set();
#endif

#ifdef CONFIG_USB_OXU210HP_HCD
  smdkv210_oxu210hp_set();
#endif
...
/* by netmania : This code affect ethernet operation, I don't know why this code affect ethernet operation */
#if !defined(CONFIG_MACH_EMPOS3) && !defined(CONFIG_MACH_ADKSV210) && !defined(CONFIG_MACH_EDKSV210) && !defined(CONFIG_MACH_SM3SV210)
...
void s3c_setup_keypad_cfg_gpio(int rows, int columns)
{
...
#if defined(CONFIG_MACH_EMPOS3) || defined(CONFIG_MACH_ADKSV210) || defined(CONFIG_MACH_EDKSV210)
  end = S5PV210_GPH3(rows-4);

  /* Set all the necessary GPH3 pins to special-function 0 */
  ...
  for (gpio = S5PV210_GPH2(0+3); gpio < end; gpio++) {
    s3c_gpio_cfgpin(gpio, S3C_GPIO_SFN(3));
    s3c_gpio_setpull(gpio, S3C_GPIO_PULL_NONE);
  }
#elif defined(CONFIG_MACH_SM3SV210)
  end = S5PV210_GPH3(rows-6);
...
#if defined(CONFIG_MACH_SM3SV210)
static void __init sm3sv210_fixup(struct machine_desc *desc,
...
MACHINE_START(EMPOS3, "EMPOS3")
#elif defined(CONFIG_MACH_ADKSV210)
MACHINE_START(ADKSV210, "ADKSV210")
#elif defined(CONFIG_MACH_EDKSV210)
MACHINE_START(EDKSV210, "EDKSV210")
#elif defined(CONFIG_MACH_SM3SV210)
MACHINE_START(SM3SV210, "SM3SV210")
#else
