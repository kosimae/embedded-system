...
void __init s5pv210_map_io(void)
{
  ...
  // raoudi-20101108
  printk("######################################################## \n");
  printk("S5P_VA_SYSTIMER = %x\n", (unsigned long)S5P_VA_SYSTIMER);
  printk("VA_VIC2 = %x\n", (unsigned long)VA_VIC2);
  printk("VA_VIC3 = %x\n", (unsigned long)VA_VIC3);
  printk("S5P_VA_SROMC = %x\n", (unsigned long)S5P_VA_SROMC);
  printk("S5P_VA_AUDSS = %x\n", (unsigned long)S5P_VA_AUDSS);
  printk("S5P_VA_DMC0 = %x\n", (unsigned long)S5P_VA_DMC0);
  printk("S5P_VA_DMC1 = %x\n", (unsigned long)S5P_VA_DMC1);
  printk("S5P_VA_BUS_AXI_DSYS = %x\n", (unsigned long)S5P_VA_BUS_AXI_DSYS);
  printk("######################################################## \n");
#endif
}
