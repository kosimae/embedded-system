...
#define S5PV210_PA_SMC9115  (0xA0020000)
#elif defined(CONFIG_MACH_ADKSV210)
#define S5PV210_PA_SMC9115  (0xA0000000)
#elif defined(CONFIG_MACH_SM3SV210)
#define S5PV210_PA_SMC9115  (0xA8000000)
#endif
#define S5P_PA_SMC9115    S5PV210_PA_SMC9115

#if defined(CONFIG_MACH_EMPOS3) || defined(CONFIG_MACH_SM3SV210)
#define HANBACK_ST16C554_UART0          0xA0040000
#define HANBACK_ST16C554_UART1          0xA0050000
#define HANBACK_ST16C554_UART2          0xA0060000
#define HANBACK_ST16C554_UART3          0xA0070000
#endif

/* ST16C554 Quard Uart */
#define HANBACK_ST16C550_UART0          0xA0080000

#if defined(CONFIG_MACH_EMPOS3)
/* OXU210 USB 2.0 */
#define S5PV210_PA_OXU210USBHOST  0x98000000
#define S5PV210_VA_OXU210USBHOST  S3C_ADDR(0x00800000)
#define S5PV210_SZ_OXU210USBHOST  SZ_1M
#endif
