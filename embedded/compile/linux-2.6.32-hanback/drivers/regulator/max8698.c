				...
				const struct i2c_device_id *i2c_id)
{
  ...
  max8698_write_reg(max8698, MAX8698_REG_ONOFF1, 0xDE); /* Turn BUCK3 off : EN3   : Bit5 => 0 */
  max8698_write_reg(max8698, MAX8698_REG_ONOFF2, 0xB0); /* Turn LDO7 off  : ELDO7 : Bit6 => 0 */
#endif
