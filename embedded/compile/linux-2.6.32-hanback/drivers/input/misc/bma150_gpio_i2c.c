...
//
// 
//  HBE-SM3-S5V210 gpio i2c driver
//  2010.10.26
// 
//
//[*]----------------------------------------------------------------------------------------------[*]
...
#include <mach/gpio-bank.h>   // raoudi-20101001
...
//[*]----------------------------------------------------------------------------------------------[*]
//[*]----------------------------------------------------------------------------------------------[*]
#define	GPBCON					(*(unsigned long *)S5PV210_GPBCON)
#define	GPBDAT					(*(unsigned long *)S5PV210_GPBDAT)
#define	GPBPUD					(*(unsigned long *)S5PV210_GPBPUD)

#define	GPIO_I2C_SDA_CON_PORT	GPBCON
#define	GPIO_I2C_SDA_DAT_PORT	GPBDAT
#define	GPIO_SDA_PIN			6   //GPB6 --> 0

#define	GPIO_I2C_CLK_CON_PORT	GPBCON
#define	GPIO_I2C_CLK_DAT_PORT	GPBDAT
#define	GPIO_CLK_PIN			4   //GPB4 -- >//1
...
{
	GPBCON &= (~0xFFFF0000);	GPBCON |= 0x11110000;	
	GPBPUD &= (~0x0000FF00);	GPBPUD |= 0x0000AA00;	
	GPBDAT &= (~0x000000F0);	GPBDAT |= 0x00000070;	

	GPH3CON &= (~0x0000F000);	// EINT27 Input (Hardware Bug)   // raoudi-20101001
