...
#ifdef CONFIG_SM3SV210
#define PS_HOLD_REG       __REG(ELFIN_CLOCK_POWER_BASE+PS_HOLD_CONTROL_OFFSET)
#endif
...
/* netmania EXT BUS */
#define MP01_BASE_REG       __REG(ELFIN_GPIO_BASE + 0x2E0)
#define MP04_BASE_REG       __REG(ELFIN_GPIO_BASE + 0x340)
#define MP05_BASE_REG       __REG(ELFIN_GPIO_BASE + 0x360)
#define MP06_BASE_REG       __REG(ELFIN_GPIO_BASE + 0x380)
#define MP07_BASE_REG       __REG(ELFIN_GPIO_BASE + 0x3A0)
...
#define GPH3CON_REG __REG(ELFIN_GPIO_BASE + GPH3CON_OFFSET)
#define GPH3DAT_REG __REG(ELFIN_GPIO_BASE + GPH3DAT_OFFSET)
#endif
