...
#define CONFIG_CMD_NANDTEMP
#define CONFIG_CMD_ETHDOWN
#define CONFIG_CMD_UP
#define CONFIG_CMD_USBDOWN
#define CONFIG_CMD_BDT
#define CONFIG_CMD_BOOTARGS
...
#define CONFIG_BOOTARGS       "root=/dev/mtdblock2 rootfstype=yaffs2 init=/init console=ttySAC0,115200 ip=192.168.0.165:192.168.0.160:192.168.0.1:255.255.255.0::eth0:off ethaddr=00:0b:a8:03:13:01"
#define CONFIG_ETHADDR		    00:0b:a8:03:13:01
#define CONFIG_NETMASK        255.255.255.0
#define CONFIG_IPADDR		      192.168.0.165
#define CONFIG_SERVERIP		    192.168.0.160
#define CONFIG_GATEWAYIP	    192.168.0.1
#define CONFIG_ROOT           /dev/mtdblock2
#define CONFIG_ROOTFSTYPE     yaffs2
#define CONFIG_INIT           /init
#define CONFIG_CONSOLEDEV     ttySAC0
#define CONFIG_CONSOLERATE    115200
//#define CONFIG_MEM            256M
...
#if CONFIG_DRIVER_SMC911X
#define CONFIG_DRIVER_SMC911X_BASE  0xA8000300
...
#define CONFIG_CLK_800_160_166_133      // raoudi-20101115
//#define CONFIG_CLK_800_100_166_133
//#define CONFIG_CLK_1000_200_166_133
//#define CONFIG_CLK_1000_166_166_133       // raoudi-20101115
...
#define APLL_SDIV       0x1
#elif defined(CONFIG_CLK_800_160_166_133)
#define APLL_MDIV       0xc8
#define APLL_PDIV       0x6
#define APLL_SDIV       0x1
#elif defined(CONFIG_CLK_1000_166_166_133)    // raoudi-2010115
#define APLL_MDIV       0xfa
#define APLL_PDIV       0x6
#define APLL_SDIV       0x1
...
#elif defined(CONFIG_CLK_800_160_166_133)
  #define CLK_DIV0_VAL    ((0 << APLL_RATIO) | \
                    (4 << A2M_RATIO) | \
                    (4 << HCLK_MSYS_RATIO) | \
                    (1 << PCLK_MSYS_RATIO) | \
                    (3 << HCLK_DSYS_RATIO) | \
                    ...
                    (4 << HCLK_PSYS_RATIO) | \
                    (1 << PCLK_PSYS_RATIO))
#elif defined(CONFIG_CLK_1000_166_166_133)    // raoudi-20101115
  #define CLK_DIV0_VAL    ((0 << APLL_RATIO) | \
                    (4 << A2M_RATIO) | \
                    (5 << HCLK_MSYS_RATIO) | \
                    (1 << PCLK_MSYS_RATIO) | \
...
#elif defined(CONFIG_CLK_800_200_166_133) || \
  defined(CONFIG_CLK_800_160_166_133) || \
  defined(CONFIG_CLK_1000_166_166_133) || \
...
#if defined(CONFIG_MCP_SINGLE)
//#define DMC0_MEMCONFIG_0  0x20f013f3  /* MemConfig0 Base 20000000, 256MB config */
#define DMC0_MEMCONFIG_0  0x20f013f3  /* MemConfig0 Base 20000000, 256MB config */
#define DMC0_MEMCONFIG_1  0x00F813f3

#define DMC0_TIMINGA_REF  0x0000030C
...
#define DMC1_MEMCONFIG_0  0x40f013f3  /* MemConfig1 Base 40000000, 256MB config */
#define DMC1_MEMCONFIG_1  0x00f013f3
...
#define DMC0_MEMCONFIG_0  0x20f01313  // MemConfig0 256MB config, 8 banks,Mapping Method[12:15]0:linear, 1:linterleaved, 2:Mixed
#define DMC0_MEMCONFIG_1  0x00F01313  // MemConfig1
#define DMC0_TIMINGA_REF  0x00000618  // TimingAref 7.8us*133MHz=1038(0x40E), 100MHz=780(0x30C), 20MHz=156(0x9C), 10MHz=78(0x4E)
#define DMC0_TIMING_ROW   /*0x1a233309*/ /*SDKIM*/ 0x28233287 // TimingRow  for @200MHz
#define DMC0_TIMING_DATA  /*0x23230303*/ /*SDKIM*/ 0x23240304 // TimingData CL=3
#define DMC0_TIMING_PWR   /*0x08c80232*/ /*SDKIM*/ 0x09C80232 // TimingPower
...
//#define SDRAM_BANK_SIZE         0x20000000    /* 256 MB */
...
#define CONFIG_IDENT_STRING	" for HBE-SMIII-SV210"
...
#define CFG_LCD_LTE480WV			// for V210 - LTE480WV
//#define CFG_LCD_LTP700WV      // for V210 - LTP700WV
//#define CFG_LCD_FBUFFER				(0x48000000)
#define CFG_LCD_FBUFFER				(0x21000000)

#define CONFIG_BOOTDELAY	3
#if defined(CFG_FASTBOOT_NANDBSP)
#define CONFIG_BOOTCOMMAND  "nand read c0008000 80000 3c0000; bootm c0008000"
