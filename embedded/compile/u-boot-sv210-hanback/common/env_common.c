...
#ifdef CONFIG_ROOT
	"root="	MK_STR(CONFIG_ROOT)	"\0"
#endif
#ifdef CONFIG_ROOTFSTYPE
	"rootfstype="	MK_STR(CONFIG_ROOTFSTYPE)	"\0"
#endif
#ifdef CONFIG_INIT
	"init="	MK_STR(CONFIG_INIT)	"\0"
#endif
#ifdef CONFIG_CONSOLEDEV
	"consoledev="	MK_STR(CONFIG_CONSOLEDEV)	"\0"
#endif
#ifdef CONFIG_CONSOLERATE
	"consolerate="	MK_STR(CONFIG_CONSOLERATE)	"\0"
#endif
#ifdef CONFIG_MEM
	"mem="	MK_STR(CONFIG_MEM)	"\0"
#endif
#endif
